...
{
    /// <summary>
    /// Represents an Intercom system entity in the building.
    /// Module: IntercomCRUD (Module ID: 9)
    /// </summary>
    [Table("Intercoms")]
    public class Intercom : ICreatedByEntity
    {
        /// <summary>
        ...
        /// <summary>
        /// Navigation property to the building where this intercom system is installed.
        /// </summary>
