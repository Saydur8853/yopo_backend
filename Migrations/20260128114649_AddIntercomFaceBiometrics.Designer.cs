...
namespace YopoBackend.Migrations
{
    ...
    [Migration("20260128114649_AddIntercomFaceBiometrics")]
    partial class AddIntercomFaceBiometrics
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YopoBackend.Modules.Messaging.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReceiverId", "ReceiverType");
            ...
            modelBuilder.Entity("YopoBackend.Modules.TermsConditionsCRUD.Models.TermsAndCondition", b =>
                {
                    b.Property<int>("TermsAndConditionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("TermsAndConditionId"));
                    ...
                    b.Property<string>("UsedPlace")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("varchar(200)")
                        .HasColumnName("UsedPlace");
            ...
            modelBuilder.Entity("YopoBackend.Modules.ThreadSocial.Models.ThreadPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YopoBackend.Modules.VerifyIdentity.Models.IdentityVerificationDocument", b =>
                {
                    ...
                    b.ToTable("IdentityVerificationDocuments");
                });

            modelBuilder.Entity("YopoBackend.Modules.VerifyIdentity.Models.IdentityVerificationRequest", b =>
                {
                    b.Property<int>("RequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YopoBackend.Modules.TicketCRUD.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("YopoBackend.Modules.UserCRUD.Models.User", "DeletedByUser")
                        .WithMany()
                        .HasForeignKey("DeletedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("YopoBackend.Modules.UserCRUD.Models.User", "TenantUser")
                        .WithMany()
            ...
            modelBuilder.Entity("YopoBackend.Modules.VerifyIdentity.Models.IdentityVerificationDocument", b =>
                {
                    b.HasOne("YopoBackend.Modules.VerifyIdentity.Models.IdentityVerificationRequest", "Request")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("YopoBackend.Modules.VerifyIdentity.Models.IdentityVerificationRequest", b =>
                {
                    ...
                    b.HasOne("YopoBackend.Modules.UserCRUD.Models.User", "VerifiedByUser")
                        .WithMany()
